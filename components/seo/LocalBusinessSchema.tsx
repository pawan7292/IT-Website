export function LocalBusinessSchema() {
  const schema = {
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://digitalmarmat.com/logo.png',
      width: 200,
      height: 200,
    },
    image: 'https://digitalmarmat.com/logo.png',
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Website Development',    url: 'https://digitalmarmat.com/services/website-development'   } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'SEO Services',           url: 'https://digitalmarmat.com/services/seo-services'          } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Digital Marketing',      url: 'https://digitalmarmat.com/services/digital-marketing'     } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Social Media Marketing', url: 'https://digitalmarmat.com/services/social-media-marketing' } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Mobile App Development', url: 'https://digitalmarmat.com/services/mobile-app-development' } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'UI/UX Design',           url: 'https://digitalmarmat.com/services/ui-ux-design'          } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'E-Commerce Development', url: 'https://digitalmarmat.com/services/ecommerce-development'  } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Branding & Design',      url: 'https://digitalmarmat.com/services/branding-design'       } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Software Development',   url: 'https://digitalmarmat.com/services/software-development'  } },
        { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'AI Automation',          url: 'https://digitalmarmat.com/services/ai-automation'         } },
      ],
    },
    sameAs: [
      'https://www.facebook.com/digitalmarmatit',
      'https://www.instagram.com/digitalmarmat.tech/',
      'https://www.linkedin.com/company/digitalmarmat',
    ],
    founder: [
