...
export const metadata: Metadata = {
  title: { absolute: 'Blog | SEO, Marketing & Web Dev Insights — Digital Marmat' },
  ...
  openGraph: {
    ...
    url: 'https://www.digitalmarmat.com.np/blog',
  ...
  alternates: { canonical: 'https://www.digitalmarmat.com.np/blog' },
}
